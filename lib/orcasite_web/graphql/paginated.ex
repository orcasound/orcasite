defmodule OrcasiteWeb.Paginated do
  ...
  def format(%{entries: entries} = paginated_list) do
    %__MODULE__{entries: entries, meta: meta(paginated_list)}
  end

  def format(non_paginated_list), do: non_paginated_list
