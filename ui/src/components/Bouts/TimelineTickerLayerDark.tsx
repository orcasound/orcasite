...
import { TICKER_HEIGHT, timeToOffset } from "./SpectrogramTimelineDark";

export function TimelineTickerLayerDark({
      ...
      {Array(ticks)
        ...
        .map((_tick, idx) => {
          return (
            <Box
              key={idx}
              className="timeline-ticker-layer"
              zIndex={zIndex}
