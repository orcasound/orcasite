...
- **Pages.** `getStaticProps` and `getStaticPaths` run during the build, so pages showing environment-specific data render per request instead — see [`listen/index.tsx`](ui/src/pages/listen/index.tsx).
